    ...
    <Router>
          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              <li className="nav-item">
                <NavLink className="nav-link" to="/activities" activeclassname="active">Activities</NavLink>
              </li>
              <li className="nav-item">
              ...
              <li className="nav-item">
                <NavLink className="nav-link" to="/workouts" activeclassname="active">Workouts</NavLink>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className="container">
        <Routes>
          ...
          <Route path="/" element={<h2>Welkom bij de Octofit Tracker!</h2>} />
        </Routes>
      </div>
    </Router>
  );
